...
import com.go4.application.historical.MovieDemo.Controller.DataController;
import com.go4.application.historical.MovieDemo.adapter.LoadMoreSearchResultAdapter;
import com.go4.application.historical.MovieDemo.listener.SearchResultEndlessRecyclerOnScrollListener;
...
public class MovieScroller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //EditText editTextSearch = findViewById(android.R.id.editTextSearch);
        //Button buttonSearch = findViewById(android.R.id.buttonSearch);
