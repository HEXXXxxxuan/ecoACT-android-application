...
public class LoadMoreSearchResultAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof RecyclerViewHolder) {
            ...
            recyclerViewHolder.tvGenres.setText(dataList.get(position).get("genres").toString());
            recyclerViewHolder.tvYear.setText(dataList.get(position).get("year").toString());
            recyclerViewHolder.tvRating.setText(dataList.get(position).get("averageRating").toString() + " star");
    ...
    private class RecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvTitle, tvGenres, tvYear, tvRating;
